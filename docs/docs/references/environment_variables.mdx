...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Check disk-staged CUDA graph lookup IDs on the first replay after capture and every N replays after that. Set 0 for the first-replay check only, 1 for every replay, or a larger value to reduce the diagnostic work proportionally.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>8</code></td>
    </tr>
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>`SGLANG_PLE_DISK_VALIDATE_GRAPH_STAGING`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Compare disk-staged PLE rows with the rows consumed by the next CUDA graph replay. This diagnostic adds a device comparison and an asynchronous host result copy.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>false</code></td>
    </tr>
    <tr>
