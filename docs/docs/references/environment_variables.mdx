...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>`SGLANG_PLE_DISK_GRAPH_LOOKUP_VALIDATION_INTERVAL`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Check disk-staged CUDA graph lookup IDs on the first replay after capture and every N replays after that. The asynchronous result is reported by the following replay without a host wait. Set 0 for the first-replay check only, 1 for every replay, or a larger value to reduce the diagnostic work proportionally.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>8</code></td>
    </tr>
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>`SGLANG_PLE_DISK_VALIDATE_GRAPH_STAGING`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Compare disk-staged PLE rows with the rows consumed by the next CUDA graph replay. This diagnostic waits for its host result and can perturb scheduling under load.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>false</code></td>
    </tr>
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>`SGLANG_PLE_DISK_VALIDATE_ROW_CONTENT`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Compare fetched host rows with a separate CRC-checked image reader and publish mismatch counters. This optional check does not cover the device transfer or CUDA graph consumption.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>false</code></td>
    </tr>
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}>`SGLANG_PLE_DISK_ROW_TRACE`</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Write PLE lookup and host-row hashes to a bounded JSONL trace. Use <code>&#123;rank&#125;</code> in the path, or SGLang adds a rank suffix.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}><code>""</code></td>
    </tr>
    <tr>
