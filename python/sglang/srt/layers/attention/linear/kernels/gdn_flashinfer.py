...
class FlashInferGDNKernel(LinearAttnKernelBase):
    ...
    def __init__(self):
        ...
        self.sm_major = torch.cuda.get_device_capability()[0]
        self.use_state_pool = self.sm_major == 10
        self.supports_target_verify = self.sm_major in (9, 10)

        if self.sm_major in (9, 12) and self._prefill_fn is None:
    ...
    def decode(
        ...
        **kwargs,
        ...
        if self.sm_major == 12 and ssm_states.dtype != torch.float32:
            raise RuntimeError(
