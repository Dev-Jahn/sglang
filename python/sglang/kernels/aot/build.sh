...
if [ "${RUN_TESTS_FLAG}" = "1" ]; then
  REQUIRE_IO_URING_FLAG="${SGL_KERNEL_PLE_REQUIRE_IO_URING:-1}"
else
...
echo "SGL_KERNEL_RUN_TESTS: ${RUN_TESTS_FLAG}"
echo "SGL_KERNEL_PLE_REQUIRE_IO_URING: ${REQUIRE_IO_URING_FLAG}"
